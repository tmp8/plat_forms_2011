...
class FactorydefaultsTest < ActiveSupport::TestCase
  ...
  context "reset" do
    ...
    should "empty database and create admin user" do
      Factory(:conference)
      ...
      assert_equal [User.find_by_username('admin')], User.all
      assert_equal 0, Conference.count
    end
  end
end
